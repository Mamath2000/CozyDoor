...
echo ""
echo "3. Installer comme service système :"
echo "   sudo make install-service IP=192.168.0.17 NAME=porte_entree FRIENDLY_NAME=\"Porte d'Entrée\""
echo ""
echo "4. Voir toutes les commandes disponibles :"
echo "   make help"
echo ""
echo "📖 Documentation :"
